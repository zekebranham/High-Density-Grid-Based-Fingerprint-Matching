...
class Triplet:
    def __init__(self, minutiae: List[MinutiaPoint]):
        self.minutiae = self._shift_clockwise(minutiae)
        self.distances = self._calculate_distances()
        self.angles = self._calculate_angles()

    def _shift_clockwise(self, minutiae: List[MinutiaPoint]) -> List[MinutiaPoint]:
...
def form_and_analyze_triplets_for_grid(minutiae: List[MinutiaPoint]) -> List[Triplet]:
